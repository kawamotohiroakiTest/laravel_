    ...
    @csrf
        <div class="post_form_area">
            <div class="post_flex">
                ...
                <input name="products_name" class="form-control" value=""/>
            </div>
        </div>
        <div class="post_form_area">
            <div class="post_flex">
                <label for="exampleInputEmail1" class="form-label post_form_label">商品コード</label>
                <input type="number" name="products_code" class="form-control" placeholder="タイトルの入力欄"/>
            </div>
        </div>
        <div class="post_form_area">
            <div class="post_flex">
                <label for="exampleInputEmail1" class="form-label post_form_label">商品価格</label>
                <textarea type="number" name="products_price" class="form-control" placeholder="内容の入力"></textarea>
            </div>
        </div>
        <div class="post_form_area">
            <div class="post_flex">
                <label for="exampleInputEmail1" class="form-label post_form_label">商品在庫</label>
                <textarea type="number" name="products_stock" class="form-control" placeholder="内容の入力"></textarea>
            </div>
        </div>
        <div class="post_form_area">
            <div class="post_flex">
        ...
        <div class="post_form_area">
            <div class="post_flex">
                ...
                <textarea type="number" name="products_postage" class="form-control" placeholder="内容の入力"></textarea>
            </div>
        </div>
        <div class="post_form_area">
            <div class="post_flex">
